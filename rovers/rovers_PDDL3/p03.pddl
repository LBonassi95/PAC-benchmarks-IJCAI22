...
(:constraints (and (sometime-before (or (communicated_soil_data waypoint2) (communicated_rock_data waypoint0) (communicated_image_data objective0 colour)) (exists (?r - rover) (have_soil_analysis ?r waypoint2)))
(sometime-before (or (communicated_soil_data waypoint2) (communicated_rock_data waypoint0) (communicated_image_data objective0 colour)) (exists (?r - rover) (have_rock_analysis ?r waypoint0)))
(sometime-before (or (communicated_soil_data waypoint2) (communicated_rock_data waypoint0) (communicated_image_data objective0 colour)) (exists (?r - rover) (have_image ?r objective0 colour)))
(sometime-before (communicated_soil_data waypoint2) (communicated_rock_data waypoint0))
(sometime-before (communicated_rock_data waypoint0) (communicated_image_data objective0 colour))

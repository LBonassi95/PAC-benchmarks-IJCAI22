...
(:constraints (and (sometime-before (or (communicated_soil_data waypoint3) (communicated_rock_data waypoint1) (communicated_image_data objective0 high_res)) (exists (?r - rover) (have_soil_analysis ?r waypoint3)))
(sometime-before (or (communicated_soil_data waypoint3) (communicated_rock_data waypoint1) (communicated_image_data objective0 high_res)) (exists (?r - rover) (have_rock_analysis ?r waypoint1)))
(sometime-before (or (communicated_soil_data waypoint3) (communicated_rock_data waypoint1) (communicated_image_data objective0 high_res)) (exists (?r - rover) (have_image ?r objective0 high_res)))

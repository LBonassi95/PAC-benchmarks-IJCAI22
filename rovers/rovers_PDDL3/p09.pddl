...
(:constraints (and (sometime-before (or (communicated_soil_data waypoint6) (communicated_soil_data waypoint4) (communicated_soil_data waypoint0) (communicated_rock_data waypoint6) (communicated_rock_data waypoint0) (communicated_rock_data waypoint3) (communicated_image_data objective2 low_res) (communicated_image_data objective2 colour)) (exists (?r - rover) (have_soil_analysis ?r waypoint6)))
(sometime-before (or (communicated_soil_data waypoint6) (communicated_soil_data waypoint4) (communicated_soil_data waypoint0) (communicated_rock_data waypoint6) (communicated_rock_data waypoint0) (communicated_rock_data waypoint3) (communicated_image_data objective2 low_res) (communicated_image_data objective2 colour)) (exists (?r - rover) (have_soil_analysis ?r waypoint4)))
(sometime-before (or (communicated_soil_data waypoint6) (communicated_soil_data waypoint4) (communicated_soil_data waypoint0) (communicated_rock_data waypoint6) (communicated_rock_data waypoint0) (communicated_rock_data waypoint3) (communicated_image_data objective2 low_res) (communicated_image_data objective2 colour)) (exists (?r - rover) (have_soil_analysis ?r waypoint0)))
...
(sometime-before (communicated_soil_data waypoint6) (communicated_soil_data waypoint4))
(sometime-before (communicated_soil_data waypoint4) (communicated_soil_data waypoint0))
(sometime-before (communicated_soil_data waypoint0) (communicated_rock_data waypoint6))
(sometime-before (communicated_rock_data waypoint6) (communicated_rock_data waypoint0))
(sometime-before (communicated_rock_data waypoint0) (communicated_rock_data waypoint3))
(sometime-before (communicated_rock_data waypoint3) (communicated_image_data objective2 low_res))
(sometime-before (communicated_image_data objective2 low_res) (communicated_image_data objective2 colour))

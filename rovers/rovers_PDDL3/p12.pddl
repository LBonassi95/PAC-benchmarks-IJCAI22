...
(:constraints (and (sometime-before (or (communicated_soil_data waypoint0) (communicated_rock_data waypoint3) (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res)) (exists (?r - rover) (have_soil_analysis ?r waypoint0)))
(sometime-before (or (communicated_soil_data waypoint0) (communicated_rock_data waypoint3) (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res)) (exists (?r - rover) (have_rock_analysis ?r waypoint3)))
(sometime-before (or (communicated_soil_data waypoint0) (communicated_rock_data waypoint3) (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res)) (exists (?r - rover) (have_rock_analysis ?r waypoint6)))
(sometime-before (or (communicated_soil_data waypoint0) (communicated_rock_data waypoint3) (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res)) (exists (?r - rover) (have_image ?r objective2 low_res)))
(sometime-before (or (communicated_soil_data waypoint0) (communicated_rock_data waypoint3) (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res)) (exists (?r - rover) (have_image ?r objective1 high_res)))
(sometime-before (or (communicated_soil_data waypoint0) (communicated_rock_data waypoint3) (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res)) (exists (?r - rover) (have_image ?r objective3 low_res)))
(sometime-before (communicated_soil_data waypoint0) (communicated_rock_data waypoint3))
(sometime-before (communicated_rock_data waypoint3) (communicated_rock_data waypoint6))
(sometime-before (communicated_rock_data waypoint6) (communicated_image_data objective2 low_res))
(sometime-before (communicated_image_data objective2 low_res) (communicated_image_data objective1 high_res))
(sometime-before (communicated_image_data objective1 high_res) (communicated_image_data objective3 low_res))

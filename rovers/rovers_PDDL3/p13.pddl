...
(sometime-before (communicated_soil_data waypoint7) (communicated_soil_data waypoint5))
...
(sometime-before (communicated_rock_data waypoint4) (communicated_rock_data waypoint6))
(sometime-before (communicated_rock_data waypoint6) (communicated_rock_data waypoint7))
(sometime-before (communicated_rock_data waypoint7) (communicated_rock_data waypoint8))
(sometime-before (communicated_rock_data waypoint8) (communicated_rock_data waypoint1))
(sometime-before (communicated_rock_data waypoint1) (communicated_image_data objective3 high_res))
(sometime-before (communicated_image_data objective3 high_res) (communicated_image_data objective1 high_res))
(sometime-before (communicated_image_data objective1 high_res) (communicated_image_data objective2 high_res))

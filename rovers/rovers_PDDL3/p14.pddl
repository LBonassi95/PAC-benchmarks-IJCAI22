...
(:constraints (and (sometime-before (or (communicated_soil_data waypoint3) (communicated_soil_data waypoint6) (communicated_rock_data waypoint5) (communicated_rock_data waypoint4) (communicated_rock_data waypoint8) (communicated_image_data objective0 colour) (communicated_image_data objective2 low_res) (communicated_image_data objective0 low_res)) (exists (?r - rover) (have_soil_analysis ?r waypoint3)))
(sometime-before (or (communicated_soil_data waypoint3) (communicated_soil_data waypoint6) (communicated_rock_data waypoint5) (communicated_rock_data waypoint4) (communicated_rock_data waypoint8) (communicated_image_data objective0 colour) (communicated_image_data objective2 low_res) (communicated_image_data objective0 low_res)) (exists (?r - rover) (have_soil_analysis ?r waypoint6)))
...
(sometime-before (communicated_soil_data waypoint3) (communicated_soil_data waypoint6))
(sometime-before (communicated_soil_data waypoint6) (communicated_rock_data waypoint5))
(sometime-before (communicated_rock_data waypoint5) (communicated_rock_data waypoint4))
(sometime-before (communicated_rock_data waypoint4) (communicated_rock_data waypoint8))
(sometime-before (communicated_rock_data waypoint8) (communicated_image_data objective0 colour))
(sometime-before (communicated_image_data objective0 colour) (communicated_image_data objective2 low_res))
(sometime-before (communicated_image_data objective2 low_res) (communicated_image_data objective0 low_res))

...
(sometime-before (communicated_soil_data waypoint18) (communicated_soil_data waypoint8))
(sometime-before (communicated_soil_data waypoint8) (communicated_soil_data waypoint5))
(sometime-before (communicated_soil_data waypoint5) (communicated_rock_data waypoint17))
(sometime-before (communicated_rock_data waypoint17) (communicated_rock_data waypoint6))
(sometime-before (communicated_rock_data waypoint6) (communicated_rock_data waypoint9))
(sometime-before (communicated_rock_data waypoint9) (communicated_rock_data waypoint19))
(sometime-before (communicated_rock_data waypoint19) (communicated_rock_data waypoint3))
(sometime-before (communicated_rock_data waypoint3) (communicated_rock_data waypoint4))
(sometime-before (communicated_rock_data waypoint4) (communicated_image_data objective7 low_res))
(sometime-before (communicated_image_data objective7 low_res) (communicated_image_data objective4 high_res))
(sometime-before (communicated_image_data objective4 high_res) (communicated_image_data objective0 colour))
(sometime-before (communicated_image_data objective0 colour) (communicated_image_data objective6 low_res))
(sometime-before (communicated_image_data objective6 low_res) (communicated_image_data objective7 colour))
(sometime-before (communicated_image_data objective7 colour) (communicated_image_data objective2 low_res))
(sometime-before (communicated_image_data objective2 low_res) (communicated_image_data objective0 high_res))
(sometime-before (communicated_image_data objective0 high_res) (communicated_image_data objective5 colour))

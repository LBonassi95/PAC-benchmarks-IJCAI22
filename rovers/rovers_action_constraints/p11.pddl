...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint1 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint1 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint6 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint6 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint0 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint0 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint1 ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint2 ?x waypoint1)))))))

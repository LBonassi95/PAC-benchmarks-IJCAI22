...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint5 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint1 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint8 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint9))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint5)))
...
(sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint5 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint1 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint8 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint9))) (exists (?r - rover ?p - waypoint ?i - camera) (take_image ?r ?p objective1 ?i high_res)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint5 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint2 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint1 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint1 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint8 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint8 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint9)))
(always (and (forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 colour ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 colour ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 high_res ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint10 ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint7 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 colour ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint9 ?x waypoint9)))

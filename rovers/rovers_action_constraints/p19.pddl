...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint5 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint5 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint17 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint17 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint6 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint6 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint19 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint19 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint3 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint3 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 low_res ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 low_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 high_res ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 high_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 colour ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 colour ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective6 low_res ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective6 low_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 low_res ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 low_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 colour ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint17 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint11 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 high_res ?x waypoint6)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective1 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint14 ?x waypoint6)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint15)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint3 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint15 ?x waypoint6)))

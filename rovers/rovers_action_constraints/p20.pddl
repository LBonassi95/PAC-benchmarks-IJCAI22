...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint23 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint7 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint11 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint13 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint20 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint14 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint22 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint16 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint12 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint18 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 high_res ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 colour ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 high_res ?x waypoint1))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint8)))
...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint23 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint23 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint7 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint7 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint11 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint11 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint13 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint13 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint20 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint20 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint14 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint14 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint22 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint22 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint16 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint16 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint12 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint12 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint18 ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint18 ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 high_res ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 high_res ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 colour ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 colour ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint1)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint1)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 high_res ?x waypoint1)))
(always (and (forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 low_res ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 colour ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 colour ?x waypoint1)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective4 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 colour ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint18 ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint24 ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 low_res ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint9 ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 low_res ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint22 ?x waypoint1)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective0 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint17 ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 low_res ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint15 ?x waypoint1)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective3 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 high_res ?x waypoint1)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective0 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 colour ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint0 ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 low_res ?x waypoint1)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective6 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 low_res ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 high_res ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 high_res ?x waypoint1)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 high_res ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint1 ?x waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 low_res ?x waypoint1)))))))

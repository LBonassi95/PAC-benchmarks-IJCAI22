...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint23 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint34 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint16 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint12 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint6 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint24 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint33 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 high_res ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 high_res ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint31))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint23)))
...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint23 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint34 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint34 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint16 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint16 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint12 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint12 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint6 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint6 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint24 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint24 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint33 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint33 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 high_res ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 high_res ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 high_res ?x waypoint31)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 high_res ?x waypoint31)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint31)))
(always (and (forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective6 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint15 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 colour ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 low_res ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint10)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint11 ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective7 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint29 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint10 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint25 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint8 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 colour ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 low_res ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint7)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 colour ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 low_res ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint30 ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_rock ?r ?s waypoint34)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 high_res ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint7 ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective4 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint15 ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective7 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 low_res ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint25)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 colour ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint6 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint20 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 colour ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 low_res ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint22)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint8 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint34 ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint22 ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 high_res ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint27 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 high_res ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint27)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 high_res ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint13 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint0 ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 low_res ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint27 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint16 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 colour ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint26 ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 high_res ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint7 ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective0 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint19 ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective4 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint28 ?x waypoint31)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 colour ?x waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 low_res ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective2 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint5 ?x waypoint31)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint19)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 high_res ?x waypoint31)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective5 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 low_res ?x waypoint31)))

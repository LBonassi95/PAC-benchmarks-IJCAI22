...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint17 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint1 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint38 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint14 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint24 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint31 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint25 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective6 low_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective9 high_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective8 high_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 high_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint2))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint17)))
...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint17 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint18 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint1 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint1 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint38 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint38 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint14 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint14 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint24 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint24 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint31 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint31 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint25 ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint25 ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective6 low_res ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective6 low_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective9 high_res ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective9 high_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective8 high_res ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective8 high_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 high_res ?x waypoint2)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective3 high_res ?x waypoint2)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint2)))
(always (and (forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint2 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective8 colour ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 colour ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 colour ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective5 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint28 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective8 low_res ?x waypoint2)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint31)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 high_res ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 low_res ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint16 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint9 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint26 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint11 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 high_res ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective9 colour ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 low_res ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 low_res ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint5 ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective0 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint0 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint37 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint4 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint27 ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective2 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint21 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective9 low_res ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective1 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 high_res ?x waypoint2)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint32)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint4 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint38 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint23 ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint31 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 low_res ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective2 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint12 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 colour ?x waypoint2)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint24)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 colour ?x waypoint2)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 low_res ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective5 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 high_res ?x waypoint2)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 high_res ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 colour ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint14 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint24 ?x waypoint2)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective6 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint27 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint2 ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 colour ?x waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint32 ?x waypoint2)))))))

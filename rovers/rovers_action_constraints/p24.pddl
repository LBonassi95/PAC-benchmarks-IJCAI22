...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint39 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint34 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint11 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint7 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint12 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint36 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint22 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint18 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint36 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint34 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint3 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint37 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint20 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint0 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint32 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 colour ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint3))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint10)))
...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint39 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint39 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint34 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint34 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint11 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint11 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint7 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint7 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint12 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint12 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint36 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint36 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint22 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint22 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint18 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint18 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint36 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint36 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint34 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint34 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint3 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint3 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint37 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint37 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint20 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint20 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint0 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint0 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint32 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint32 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint21 ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 colour ?x waypoint3)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective4 colour ?x waypoint3)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 low_res ?x waypoint3)))
(always (and (forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint2 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint20 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 low_res ?x waypoint3)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint5 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint33 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 colour ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint11 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 colour ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint31 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint1 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint8 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint26 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 high_res ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 high_res ?x waypoint3)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint12 ?x waypoint3)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint30 ?x waypoint3)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint18 ?x waypoint3)))

...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint21 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint16 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 colour ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 colour ?x waypoint9))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint14)))
...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint21 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint21 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint16 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint16 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint2 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint7 ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 colour ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 colour ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint9)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective1 high_res ?x waypoint9)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective2 colour ?x waypoint9)))
(always (and (forall (?r - rover ?s - store) (not (sample_rock ?r ?s waypoint5)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint10)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint17)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint3 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint23 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint13 ?x waypoint9)))
(forall (?r - rover ?s - store) (not (sample_rock ?r ?s waypoint12)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 colour ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint3 ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 colour ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 low_res ?x waypoint9)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective4 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint17 ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint22 ?x waypoint9)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint23)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 colour ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint15 ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective1 low_res ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 low_res ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective0 high_res ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint10 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint1 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 colour ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint24 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint6 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint15 ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint11 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint1 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 low_res ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint5 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 high_res ?x waypoint9)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint1)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint6 ?x waypoint9)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective3 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint24 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 low_res ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 low_res ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint14 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint20 ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 high_res ?x waypoint9)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint24)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint2 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint19 ?x waypoint9)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint2)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 high_res ?x waypoint9)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint12 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint4 ?x waypoint9)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint11 ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective3 high_res ?x waypoint9)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint4 ?x waypoint9)))

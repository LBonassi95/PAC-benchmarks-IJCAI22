...
(:constraints (and (sometime-before (or (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint25 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint21 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint32 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint32 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint29 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint28 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint11 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint26 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 high_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 colour ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint6))) (exists (?r - rover ?s - store) (sample_soil ?r ?s waypoint25)))
...
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint25 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint3 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint14 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint21 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint21 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint32 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint32 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint10 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint8 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_soil_data ?r general waypoint0 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint32 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint32 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint29 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint29 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint28 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint28 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint11 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint11 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint10 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint9 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint4 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint26 ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_rock_data ?r general waypoint26 ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective7 colour ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 high_res ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 high_res ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 colour ?x waypoint6)))
(sometime-before (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective5 colour ?x waypoint6)) (exists (?r - rover ?x - waypoint) (communicate_image_data ?r general objective0 high_res ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint24 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 colour ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint20 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective4 high_res ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 colour ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 low_res ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 low_res ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint18 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint1 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint6 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint21 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint14 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint16 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective7 high_res ?x waypoint6)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective2 ?i high_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective2 high_res ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint0 ?x waypoint6)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective0 ?i low_res)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint18 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint5 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint3 ?x waypoint6)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective2 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective6 high_res ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint27 ?x waypoint6)))
...
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint15 ?x waypoint6)))
(forall (?r - rover ?s - store) (not (sample_rock ?r ?s waypoint27)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint27 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_rock_data ?r general waypoint23 ?x waypoint6)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint18)))
(forall (?r - rover ?s - store) (not (sample_soil ?r ?s waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint12 ?x waypoint6)))
(forall (?r - rover ?p - waypoint ?i - camera) (not (take_image ?r ?p objective6 ?i colour)))
(forall (?r - rover ?x - waypoint) (not (communicate_image_data ?r general objective5 low_res ?x waypoint6)))
(forall (?r - rover ?s - store) (not (sample_rock ?r ?s waypoint21)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint19 ?x waypoint6)))
(forall (?r - rover ?x - waypoint) (not (communicate_soil_data ?r general waypoint4 ?x waypoint6)))))))

...
(eventually (and (not (on crate0 depot0-1-4)) (next (on crate0 depot0-1-4)) (next (eventually (and (not (on crate1 depot0-2-4)) (next (on crate1 depot0-2-4)) (next (eventually (and (not (on crate2 depot0-1-3)) (next (on crate2 depot0-1-3)) (next (eventually (and (not (on crate3 depot0-2-3)) (next (on crate3 depot0-2-3))))))))))))))) 

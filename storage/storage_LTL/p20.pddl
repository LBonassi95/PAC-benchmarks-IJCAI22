...
(eventually (and (not (on crate0 depot0-1-1)) (next (on crate0 depot0-1-1)) (next (eventually (and (not (on crate1 depot0-2-1)) (next (on crate1 depot0-2-1)) (next (eventually (and (not (on crate2 depot0-1-2)) (next (on crate2 depot0-1-2)) (next (eventually (and (not (on crate3 depot1-1-3)) (next (on crate3 depot1-1-3)) (next (eventually (and (not (on crate4 depot1-2-3)) (next (on crate4 depot1-2-3)) (next (eventually (and (not (on crate5 depot1-1-2)) (next (on crate5 depot1-1-2)) (next (eventually (and (not (on crate6 depot2-1-1)) (next (on crate6 depot2-1-1)) (next (eventually (and (not (on crate7 depot2-2-1)) (next (on crate7 depot2-2-1)) (next (eventually (and (not (on crate8 depot2-1-2)) (next (on crate8 depot2-1-2)) (next (eventually (and (not (on crate9 depot2-2-2)) (next (on crate9 depot2-2-2))))))))))))))))))))))))))))))))) 

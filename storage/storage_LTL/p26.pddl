...
(eventually (and (not (on crate0 depot0-1-4)) (next (on crate0 depot0-1-4)) (next (eventually (and (not (on crate1 depot0-2-4)) (next (on crate1 depot0-2-4)) (next (eventually (and (not (on crate2 depot0-1-3)) (next (on crate2 depot0-1-3)) (next (eventually (and (not (on crate3 depot0-1-1)) (next (on crate3 depot0-1-1)) (next (eventually (and (not (on crate4 depot1-1-1)) (next (on crate4 depot1-1-1)) (next (eventually (and (not (on crate5 depot1-2-1)) (next (on crate5 depot1-2-1)) (next (eventually (and (not (on crate6 depot1-1-2)) (next (on crate6 depot1-1-2)) (next (eventually (and (not (on crate7 depot1-2-2)) (next (on crate7 depot1-2-2)) (next (eventually (and (not (on crate8 depot2-1-4)) (next (on crate8 depot2-1-4)) (next (eventually (and (not (on crate9 depot2-2-4)) (next (on crate9 depot2-2-4)) (next (eventually (and (not (on crate10 depot2-1-3)) (next (on crate10 depot2-1-3)) (next (eventually (and (not (on crate11 depot2-1-1)) (next (on crate11 depot2-1-1)) (next (eventually (and (not (on crate12 depot3-1-4)) (next (on crate12 depot3-1-4)) (next (eventually (and (not (on crate13 depot3-2-4)) (next (on crate13 depot3-2-4)) (next (eventually (and (not (on crate14 depot3-1-3)) (next (on crate14 depot3-1-3)) (next (eventually (and (not (on crate15 depot3-2-3)) (next (on crate15 depot3-2-3))))))))))))))))))))))))))))))))))))))))))))))))))) 

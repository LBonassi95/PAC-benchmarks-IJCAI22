...
(:constraints (and (sometime-before (on crate2 depot0-1-2) (on crate1 depot0-2-3))
(sometime-before (on crate1 depot0-2-3) (on crate0 depot0-1-3))
(forall (?c - crate) (at-most-once (exists (?h - hoist) (lifting ?h ?c))))
(sometime (on crate0 depot0-1-3))
(sometime (on crate1 depot0-2-3))

...
(:constraints (and (sometime-before (on crate3 depot0-1-2) (on crate2 depot0-1-4))
(sometime-before (on crate2 depot0-1-4) (on crate1 depot0-2-1))
(sometime-before (on crate1 depot0-2-1) (on crate0 depot0-1-1))
(forall (?c - crate) (at-most-once (exists (?h - hoist) (lifting ?h ?c))))
(sometime (on crate0 depot0-1-1))
(sometime (on crate1 depot0-2-1))
(sometime (on crate2 depot0-1-4))

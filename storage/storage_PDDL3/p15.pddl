...
(:constraints (and (sometime-before (on crate4 depot1-1-2) (on crate3 depot1-1-1))
(sometime-before (on crate3 depot1-1-1) (on crate2 depot1-2-1))
(sometime-before (on crate2 depot1-2-1) (on crate1 depot0-1-1))
...
(sometime (on crate2 depot1-2-1))
(sometime (on crate3 depot1-1-1))
(sometime (on crate4 depot1-1-2))))

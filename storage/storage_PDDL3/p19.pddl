...
(:constraints (and (sometime-before (on crate8 depot2-1-2) (on crate7 depot2-2-3))
(sometime-before (on crate7 depot2-2-3) (on crate6 depot2-1-3))
(sometime-before (on crate6 depot2-1-3) (on crate5 depot1-2-3))
(sometime-before (on crate5 depot1-2-3) (on crate4 depot1-1-1))
(sometime-before (on crate4 depot1-1-1) (on crate3 depot1-1-3))
(sometime-before (on crate3 depot1-1-3) (on crate2 depot0-2-3))
...
(sometime (on crate6 depot2-1-3))
(sometime (on crate7 depot2-2-3))

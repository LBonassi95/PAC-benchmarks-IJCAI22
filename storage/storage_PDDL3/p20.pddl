...
(:constraints (and (sometime-before (on crate9 depot2-2-2) (on crate8 depot2-1-2))
(sometime-before (on crate8 depot2-1-2) (on crate7 depot2-2-1))
...
(sometime-before (on crate2 depot0-1-2) (on crate1 depot0-2-1))

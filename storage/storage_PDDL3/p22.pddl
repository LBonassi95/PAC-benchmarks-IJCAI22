...
(:constraints (and (sometime-before (on crate11 depot2-2-2) (on crate10 depot2-1-2))
(sometime-before (on crate10 depot2-1-2) (on crate9 depot2-2-1))
(sometime-before (on crate9 depot2-2-1) (on crate8 depot2-1-1))
(sometime-before (on crate8 depot2-1-1) (on crate7 depot1-1-2))
...
(sometime-before (on crate4 depot1-1-1) (on crate3 depot0-2-3))
(sometime-before (on crate3 depot0-2-3) (on crate2 depot0-1-3))
...
(sometime (on crate10 depot2-1-2))
(sometime (on crate11 depot2-2-2))))

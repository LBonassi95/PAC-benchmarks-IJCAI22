...
(:constraints (and (sometime-before (on crate19 depot4-1-2) (on crate18 depot4-1-4))
(sometime-before (on crate18 depot4-1-4) (on crate17 depot4-2-1))
(sometime-before (on crate17 depot4-2-1) (on crate16 depot4-1-1))
(sometime-before (on crate16 depot4-1-1) (on crate15 depot3-2-3))
(sometime-before (on crate15 depot3-2-3) (on crate14 depot3-1-3))
(sometime-before (on crate14 depot3-1-3) (on crate13 depot3-2-4))
(sometime-before (on crate13 depot3-2-4) (on crate12 depot3-1-4))
(sometime-before (on crate12 depot3-1-4) (on crate11 depot2-1-1))
(sometime-before (on crate11 depot2-1-1) (on crate10 depot2-1-3))
(sometime-before (on crate10 depot2-1-3) (on crate9 depot2-2-4))
(sometime-before (on crate9 depot2-2-4) (on crate8 depot2-1-4))
(sometime-before (on crate8 depot2-1-4) (on crate7 depot1-2-2))
(sometime-before (on crate7 depot1-2-2) (on crate6 depot1-1-2))
(sometime-before (on crate6 depot1-1-2) (on crate5 depot1-2-1))
(sometime-before (on crate5 depot1-2-1) (on crate4 depot1-1-1))
(sometime-before (on crate4 depot1-1-1) (on crate3 depot0-1-2))
(sometime-before (on crate3 depot0-1-2) (on crate2 depot0-1-4))
...
(sometime (on crate5 depot1-2-1))
(sometime (on crate6 depot1-1-2))
(sometime (on crate7 depot1-2-2))
(sometime (on crate8 depot2-1-4))
(sometime (on crate9 depot2-2-4))
(sometime (on crate10 depot2-1-3))
(sometime (on crate11 depot2-1-1))
(sometime (on crate12 depot3-1-4))
(sometime (on crate13 depot3-2-4))
(sometime (on crate14 depot3-1-3))
(sometime (on crate15 depot3-2-3))
(sometime (on crate16 depot4-1-1))
(sometime (on crate17 depot4-2-1))
(sometime (on crate18 depot4-1-4))
(sometime (on crate19 depot4-1-2))))

...
(:constraints (and (pattern (exists (?h - hoist ?a2 - area) (drop ?h crate0 depot0-1-4 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate1 depot0-2-4 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate2 depot0-1-3 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate3 depot0-2-3 ?a2 depot0)))

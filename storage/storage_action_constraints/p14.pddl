...
(exists (?h - hoist ?a2 - area) (drop ?h crate2 depot0-2-1 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate3 depot1-2-1 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate4 depot1-1-1 ?a2 depot1)))

...
(exists (?h - hoist ?a2 - area) (drop ?h crate3 depot1-1-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate4 depot1-2-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate5 depot1-1-2 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate6 depot2-1-1 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate7 depot2-2-1 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate8 depot2-1-4 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate9 depot2-1-2 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate10 depot3-1-1 ?a2 depot3))	

...
(exists (?h - hoist ?a2 - area) (drop ?h crate5 depot1-1-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate6 depot1-1-1 ?a2 depot1))	
...
(exists (?h - hoist ?a2 - area) (drop ?h crate11 depot3-1-1 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate12 depot3-2-1 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate13 depot3-1-4 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate14 depot3-1-2 ?a2 depot3)))

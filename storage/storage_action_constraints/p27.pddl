...
(exists (?h - hoist ?a2 - area) (drop ?h crate3 depot1-1-4 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate4 depot1-1-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate5 depot1-2-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate6 depot1-1-2 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate7 depot2-1-1 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate8 depot2-2-1 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate9 depot2-1-2 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate10 depot3-1-3 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate11 depot3-2-3 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate12 depot4-1-3 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate13 depot4-1-1 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate14 depot4-2-3 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate15 depot4-2-1 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate16 depot4-1-2 ?a2 depot4)))

...
(exists (?h - hoist ?a2 - area) (drop ?h crate2 depot0-1-1 ?a2 depot0))	
...
(exists (?h - hoist ?a2 - area) (drop ?h crate16 depot4-1-4 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate17 depot4-1-3 ?a2 depot4)))

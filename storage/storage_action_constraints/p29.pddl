...
(exists (?h - hoist ?a2 - area) (drop ?h crate1 depot0-1-3 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate2 depot0-2-3 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate3 depot0-1-2 ?a2 depot0))	
(exists (?h - hoist ?a2 - area) (drop ?h crate4 depot1-1-4 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate5 depot1-2-4 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate6 depot1-1-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate7 depot1-2-3 ?a2 depot1))	
(exists (?h - hoist ?a2 - area) (drop ?h crate8 depot2-1-1 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate9 depot2-2-1 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate10 depot2-1-4 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate11 depot2-1-2 ?a2 depot2))	
(exists (?h - hoist ?a2 - area) (drop ?h crate12 depot3-1-4 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate13 depot3-1-3 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate14 depot3-2-3 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate15 depot3-1-2 ?a2 depot3))	
(exists (?h - hoist ?a2 - area) (drop ?h crate16 depot4-1-3 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate17 depot4-1-1 ?a2 depot4))	
(exists (?h - hoist ?a2 - area) (drop ?h crate18 depot4-2-3 ?a2 depot4)))

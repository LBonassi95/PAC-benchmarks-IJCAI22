...
(always (not (and (at truck1 market4) (next (at truck1 depot2)))))
(always (not (and (at truck1 market3) (next (at truck1 market2)))))
(always (not (and (at truck1 depot2) (next (at truck1 market4)))))
(always (not (and (at truck1 market1) (next (at truck1 market3)))))
(eventually (and (at truck1 depot1) (next (at truck1 market4)) (next (eventually (and (at truck1 market4) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 market1)) (next (eventually (and (at truck1 market1) (next (at truck1 market2)) (next (eventually (and (at truck1 market2) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 market5)) (next (eventually (and (at truck1 market5) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 market4)) (next (eventually (and (at truck1 market4) (next (at truck1 depot1))))))))))))))))))))))))))))

...
(always (not (and (at truck1 market3) (next (at truck1 market4)))))
(always (not (and (at truck1 market3) (next (at truck1 depot3)))))
(always (not (and (at truck1 market3) (next (at truck1 market2)))))
(always (not (and (at truck1 depot3) (next (at truck1 market3)))))
(always (not (and (at truck1 market5) (next (at truck1 market6)))))
(always (not (and (at truck1 market4) (next (at truck1 market3)))))
(always (not (and (at truck1 market5) (next (at truck1 depot1)))))
...
(always (not (and (at truck1 market1) (next (at truck1 market2)))))
(always (not (and (at truck1 depot1) (next (at truck1 market5)))))
(always (not (and (at truck1 market2) (next (at truck1 market4)))))
(eventually (and (at truck1 depot2) (next (at truck1 market5)) (next (eventually (and (at truck1 market5) (next (at truck1 market4)) (next (eventually (and (at truck1 market4) (next (at truck1 market2)) (next (eventually (and (at truck1 market2) (next (at truck1 market1)) (next (eventually (and (at truck1 market1) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 market6)) (next (eventually (and (at truck1 market6) (next (at truck1 market5)) (next (eventually (and (at truck1 market5) (next (at truck1 depot2)))))))))))))))))))))))))
(eventually (loaded goods1 truck1 level3))
(eventually (loaded goods2 truck1 level2))
(eventually (loaded goods3 truck1 level3))
...
(eventually (loaded goods8 truck1 level5))

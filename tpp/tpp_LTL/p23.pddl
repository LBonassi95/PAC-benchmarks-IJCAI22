...
(eventually (and (at truck1 depot3) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 market6)) (next (eventually (and (at truck1 market6) (next (at truck1 market5)) (next (eventually (and (at truck1 market5) (next (at truck1 market4)) (next (eventually (and (at truck1 market4) (next (at truck1 market2)) (next (eventually (and (at truck1 market2) (next (at truck1 market1)) (next (eventually (and (at truck1 market1) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 depot3)))))))))))))))))))))))))
...
(eventually (loaded goods9 truck1 level5))
(eventually (loaded goods10 truck1 level5))

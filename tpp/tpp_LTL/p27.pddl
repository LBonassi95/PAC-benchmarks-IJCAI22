...
(always (at truck6 depot1))
(always (at truck7 depot2))
...
(eventually (loaded goods1 truck1 level4))
(eventually (loaded goods2 truck1 level2))
(eventually (loaded goods3 truck1 level6))
(eventually (loaded goods4 truck1 level4))
(eventually (loaded goods5 truck1 level2))
(eventually (loaded goods6 truck1 level2))
(eventually (loaded goods7 truck1 level5))
(eventually (loaded goods9 truck1 level2))
(eventually (loaded goods10 truck1 level4))
(eventually (loaded goods11 truck1 level2))
(eventually (loaded goods12 truck1 level5))
(eventually (loaded goods14 truck1 level2))
(eventually (loaded goods15 truck1 level3))
(eventually (loaded goods17 truck1 level2))

...
(always (at truck5 depot1))
(always (at truck6 depot3))
(always (at truck7 depot3))
(always (at truck8 depot3))
(always (not (and (at truck1 market8) (next (at truck1 depot1)))))
...
(always (not (and (at truck1 market3) (next (at truck1 market1)))))
(always (not (and (at truck1 market5) (next (at truck1 market7)))))
(always (not (and (at truck1 depot3) (next (at truck1 market7)))))
(always (not (and (at truck1 market6) (next (at truck1 market8)))))
(always (not (and (at truck1 market1) (next (at truck1 market6)))))
...
(always (not (and (at truck1 market2) (next (at truck1 market3)))))
(always (not (and (at truck1 market4) (next (at truck1 market2)))))
(always (not (and (at truck1 market7) (next (at truck1 market2)))))
(always (not (and (at truck1 market8) (next (at truck1 market4)))))
(always (not (and (at truck1 market4) (next (at truck1 market5)))))
(always (not (and (at truck1 market5) (next (at truck1 market2)))))
(always (not (and (at truck1 market2) (next (at truck1 market4)))))
(always (not (and (at truck1 depot1) (next (at truck1 market8)))))
(eventually (and (at truck1 depot2) (next (at truck1 market7)) (next (eventually (and (at truck1 market7) (next (at truck1 market5)) (next (eventually (and (at truck1 market5) (next (at truck1 market4)) (next (eventually (and (at truck1 market4) (next (at truck1 market8)) (next (eventually (and (at truck1 market8) (next (at truck1 market6)) (next (eventually (and (at truck1 market6) (next (at truck1 market1)) (next (eventually (and (at truck1 market1) (next (at truck1 market3)) (next (eventually (and (at truck1 market3) (next (at truck1 market2)) (next (eventually (and (at truck1 market2) (next (at truck1 market7)) (next (eventually (and (at truck1 market7) (next (at truck1 depot2)))))))))))))))))))))))))))))))
(eventually (loaded goods1 truck1 level3))
(eventually (loaded goods2 truck1 level4))
(eventually (loaded goods3 truck1 level4))
(eventually (loaded goods4 truck1 level3))
(eventually (loaded goods5 truck1 level3))
(eventually (loaded goods6 truck1 level5))
(eventually (loaded goods8 truck1 level4))
(eventually (loaded goods10 truck1 level2))
(eventually (loaded goods11 truck1 level3))
(eventually (loaded goods12 truck1 level3))
(eventually (loaded goods13 truck1 level6))
(eventually (loaded goods14 truck1 level4))
(eventually (loaded goods15 truck1 level3))
(eventually (loaded goods16 truck1 level2))
(eventually (loaded goods19 truck1 level3))
(eventually (loaded goods20 truck1 level2))

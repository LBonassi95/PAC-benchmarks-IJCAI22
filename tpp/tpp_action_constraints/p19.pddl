...
(:constraints (and (pattern (drive truck1 depot1 market4)
...
(always (and (forall (?from ?to - place) (not (drive truck2 ?from ?to))) (forall (?from ?to - place) (not (drive truck3 ?from ?to))) (forall (?from ?to - place) (not (drive truck4 ?from ?to))) (forall (?from ?to - place) (not (drive truck5 ?from ?to)))))
(always (and (not (drive truck1 market4 depot2)) (not (drive truck1 depot2 market4)) (not (drive truck1 market2 market1)) (not (drive truck1 market3 market2)) (not (drive truck1 market1 market3))))
...
(sometime (exists (?m - market) (load goods13 truck1 ?m level0 level1 level3 level4)))

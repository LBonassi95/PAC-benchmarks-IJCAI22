...
(:constraints (and (pattern (drive truck1 depot3 market3)
...
(sometime (exists (?m - market) (load goods9 truck1 ?m level0 level1 level4 level5)))
(sometime (exists (?m - market) (load goods10 truck1 ?m level0 level1 level4 level5)))

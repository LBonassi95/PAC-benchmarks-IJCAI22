...
(always (and (not (drive truck1 market1 market4)) (not (drive truck1 market4 market3)) (not (drive truck1 market6 market3)) (not (drive truck1 market6 market1)) (not (drive truck1 market2 market6)) (not (drive truck1 market3 market6)) (not (drive truck1 depot1 market2)) (not (drive truck1 market7 depot3)) (not (drive truck1 market2 depot1)) (not (drive truck1 market3 market2)) (not (drive truck1 depot3 market7))))
...
(sometime (exists (?m - market) (load goods1 truck1 ?m level0 level1 level4 level5)))
(sometime (exists (?m - market) (load goods3 truck1 ?m level0 level1 level4 level5)))
(sometime (exists (?m - market) (load goods4 truck1 ?m level0 level1 level3 level4)))
(sometime (exists (?m - market) (load goods5 truck1 ?m level0 level1 level3 level4)))
...
(sometime (exists (?m - market) (load goods8 truck1 ?m level0 level1 level2 level3)))
(sometime (exists (?m - market) (load goods10 truck1 ?m level0 level1 level2 level3)))
(sometime (exists (?m - market) (load goods11 truck1 ?m level0 level1 level3 level4)))

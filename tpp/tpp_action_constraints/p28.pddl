...
(sometime (exists (?m - market) (load goods9 truck1 ?m level0 level1 level5 level6)))
...
(sometime (exists (?m - market) (load goods15 truck1 ?m level0 level1 level4 level5)))
...
(sometime (exists (?m - market) (load goods18 truck1 ?m level0 level1 level3 level4)))))

...
(:constraints (and (pattern (drive truck1 depot2 market7)
(drive truck1 market7 market5)
(drive truck1 market5 market4)
(drive truck1 market4 market8)
(drive truck1 market8 market6)
...
(always (and (not (drive truck1 depot1 market8)) (not (drive truck1 market2 market5)) (not (drive truck1 market1 market6)) (not (drive truck1 market5 market7)) (not (drive truck1 market3 market8)) (not (drive truck1 market8 depot1)) (not (drive truck1 market7 depot3)) (not (drive truck1 depot3 market7)) (not (drive truck1 market8 market4)) (not (drive truck1 market5 market1)) (not (drive truck1 market4 market5)) (not (drive truck1 market5 market2)) (not (drive truck1 market7 market2)) (not (drive truck1 market4 market2)) (not (drive truck1 market3 market1)) (not (drive truck1 market2 market3)) (not (drive truck1 market8 market3)) (not (drive truck1 market2 market4)) (not (drive truck1 market6 market8)) (not (drive truck1 market1 market5))))
...
(sometime (exists (?m - market) (load goods5 truck1 ?m level0 level1 level2 level3)))
(sometime (exists (?m - market) (load goods6 truck1 ?m level0 level1 level4 level5)))
(sometime (exists (?m - market) (load goods8 truck1 ?m level0 level1 level3 level4)))
(sometime (exists (?m - market) (load goods10 truck1 ?m level0 level1 level1 level2)))
...
(sometime (exists (?m - market) (load goods13 truck1 ?m level0 level1 level5 level6)))
(sometime (exists (?m - market) (load goods14 truck1 ?m level0 level1 level3 level4)))
(sometime (exists (?m - market) (load goods15 truck1 ?m level0 level1 level2 level3)))
(sometime (exists (?m - market) (load goods16 truck1 ?m level0 level1 level1 level2)))
(sometime (exists (?m - market) (load goods19 truck1 ?m level0 level1 level2 level3)))
(sometime (exists (?m - market) (load goods20 truck1 ?m level0 level1 level1 level2)))))

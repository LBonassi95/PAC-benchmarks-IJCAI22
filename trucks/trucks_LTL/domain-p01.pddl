...
:precondition (and (at ?t ?l) (at ?p ?l) (free ?a1 ?t) (and (imply (closer a1 ?a1) (free a1 ?t)) (imply (closer a2 ?a1) (free a2 ?t))))
...
(:action unload
:parameters ( ?p - package ?t - truck ?a1 - truckarea ?l - location)
:precondition (and (at ?t ?l) (in ?p ?t ?a1) (and (imply (closer a1 ?a1) (free a1 ?t)) (imply (closer a2 ?a1) (free a2 ?t))))

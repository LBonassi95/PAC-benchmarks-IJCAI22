...
(:init
 ...
 (:goal (and (delivered package1 l4 t4)
...
(always (or (forall (?a1 - truckarea) (not (in package7 truck1 ?a1))) (until (not (forall (?a1 - truckarea) (not (in package7 truck1 ?a1)))) (or (final) (always (forall (?a1 - truckarea) (not (in package7 truck1 ?a1)))) ))) )
(always (or (forall (?a1 - truckarea) (not (in package8 truck1 ?a1))) (until (not (forall (?a1 - truckarea) (not (in package8 truck1 ?a1)))) (or (final) (always (forall (?a1 - truckarea) (not (in package8 truck1 ?a1)))) ))) )
(always (or (forall (?a1 - truckarea) (not (in package9 truck1 ?a1))) (until (not (forall (?a1 - truckarea) (not (in package9 truck1 ?a1)))) (or (final) (always (forall (?a1 - truckarea) (not (in package9 truck1 ?a1)))) ))) ))) 
